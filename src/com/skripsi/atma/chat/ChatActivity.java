...
public class ChatActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        friend.setFullName(extras.getString("friendFullName"));
        ...
        meLabel.setText(me.getFullName() + " (me)");
        friendLabel.setText(friend.getFullName());
        ...
        if (me != null && friend != null) {
            ...
            myChatController = new ChatController(chatLogin, password);
